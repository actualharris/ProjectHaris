                ...
                <Profile/>
                    <div className="col-lg-6 d-flex flex-column align-items-center text-center">
                        ...
                        <p className="lead describe">
                            Hello and welcome! I'm Haris, an undergraduate in <span className="imp">B.Tech CSE</span>, and an aspiring <span className="imp">Information Security Analyst</span>. 
